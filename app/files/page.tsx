...
export default function FileManagerPage() {
  ...
  const [loadingFile, setLoadingFile] = useState<string | null>(null); // 新增 loading 狀態
  ...
  const handleParse = async (fileName: string) => {
    setLoadingFile(fileName); // 設定 loading 狀態
    toast(`開始解析 ${fileName}...`);
    ...
    setLoadingFile(null); // 清除 loading 狀態
  };
                ...
                <TableCell>
                  {file.parsed ? (
                    ...
                    <Button
                      ...
                      disabled={loadingFile === file.name} // 禁用按鈕
                    >
                      {loadingFile === file.name ? '解析中...' : '解析'}
                    </Button>
                  )}
                </TableCell>
